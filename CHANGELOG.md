...
- Logotype added to the README header

### Changed

- README usage instructions updated to document the VS Code deep link flow and the delete-after-reading toggle in the share panel
